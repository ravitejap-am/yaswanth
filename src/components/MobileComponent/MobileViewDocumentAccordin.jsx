          ...
          {data.map((document, index) => {
            return (
              <Accordion defaultExpanded={index == 0 ? true : false}>
                ...
                <AccordionDetails>
                  ...
                  >
                    <Box sx={{ display: 'flex', flexDirection: 'row' }}>
                      <Typography sx={{ width: '6em' }}>Size</Typography>
                      <Typography style={{ width: '0.5em' }}>:</Typography>
                      <Typography> {document.size}</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', flexDirection: 'row' }}>
                      <Typography sx={{ width: '6em' }}>Version</Typography>
                      <Typography style={{ width: '0.5em' }}>:</Typography>
                      <Typography>{document.version}</Typography>
                    </Box>
                ...
                <AccordionActions>
                  <Button onClick={() => handleEdit(document.id, document)}>
                    Edit
                  </Button>
                  <Button
                    onClick={() => {
