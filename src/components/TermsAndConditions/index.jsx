      ...
      <Box>
        ...
        <Box>
          ...
          <ul>
            ...
            <li>Transmitting any harmful or offensive content, including viruses, malware, or other destructive code.</li>
            <li>Impersonating any person or entity, or misrepresenting your affiliation with any person or entity.</li>
            <li>Interfering with or disrupting the operation of the Chatbot or any servers or networks connected to the Chatbot.</li>
            <li>Attempting to gain unauthorized access to the Chatbot, any related systems or networks, or any part of our infrastructure.</li>
          </ul>
        </Box>
        ...
        <Box>
          <h4 style={{ fontSize: '18px' }}>Governing Law and Dispute Resolution</h4>
          <p>
