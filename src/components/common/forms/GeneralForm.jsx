        ...
        if (pattern !== null && pattern !== undefined) {
            ...
            if (patternObj.test(value)) {
                ...
                if (IsErrorAvailable === true) {
                    ...
                    (IsErrorAvailable === null ||
                        IsErrorAvailable === undefined) &&
                    value?.length &&
                    value?.length > 0
                ) {
                    // const indexError = newMessages.indexOf(IsErrorAvailable);
        ...
        <Form
            ...
            onFinish={(value) => {
                ...
                if (checkPatternFound) {
                    ...
                    const AvailablePattern = formElements.filter(
                        (ItemCheck) => {
                            if (ItemCheck.pattern) {
                                const patternvalue = ItemCheck?.pattern
                                    ? ItemCheck?.pattern
                                    : ''
                                ...
                                const patternName = ItemCheck?.name
                                    ? ItemCheck?.name
                                    : ''
                                ...
                                if (result === true) {
                                    patterncountCompleted =
                                        patterncountCompleted + 1
                                }
                    ...
                    {formElements.map((item, index) => {
                            ...
                            email: (
                                <div key={'divs' + index.toString()}>
                                    <Input
                                        ...
                                        labelName={
                                            item.labelName ? item.label : null
                                        }
                                        type={item.type}
                                        placeholder={
                                            item.labelName ? null : item.label
                                        }
                        ...
                        return (
                            <Form.Item
                                name={item.name}
                                rules={
                                    item?.rules != undefined ? item.rules : []
                                }
                                    ...
                                    {domainProps?.isDomain ? (
                                        ...
                                        >
                                            ...
                                            <DeleteIcon
                                                ...
                                                onClick={() =>
                                                    domainProps?.domainDeleteHandler(
                                                        item?.domainIndex
                                                    )
                                                }
                                            />
            ...
            <Form.Item noStyle wrapperCol={{ offset: 6, span: 18 }}>
                ...
                >
                    {isSubmit && (
                        <Button
                            backgroundColor={
                                submitButtonProperty.backgroundColor
                            }
                    ...
                    {isCancel && (
                        <Button
                            ...
                            backgroundColor={
                                cancelButtonProperty.backgroundColor
                            }
