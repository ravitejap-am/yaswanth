...
export const getActiveUserList = async (headers) => {
    try {
        const data = await axios.get(`${GET_ACTIVE_USERS}`, headers)
        return data
    } catch (error) {
...
export const getChatResponse = async (body, headers) => {
    try {
        const data = await axios.post(`${CHAT}`, body, { headers: headers })
        return data
    } catch (error) {
...
export const getChatSessions = async (id, headers) => {
    try {
        const data = await axios.post(`${CHAT_OF_SESSION}${id}`, headers)
        return data
    } catch (error) {
...
export const getPlanDetails = async (headers) => {
    try {
        const data = await axios.get(`${PLAN_DETAILS}`, headers)
        return data
    } catch (error) {
...
export const getPlanDetailsById = async (id, headers) => {
    try {
        const data = await axios.get(`${DEFAULT_QUESTIONS}`, headers)
        return data
    } catch (error) {
...
export const getSessionList = async (headers) => {
    try {
        const data = await axios.get(`${LIST_OF_CHAT_SESSIONS}`, {
            headers: headers,
        })
        return data
    } catch (error) {
...
export const getQuestions = async (headers, id) => {
    try {
        const data = await axios.get(`${DEFAULT_QUESTIONS}/${id}/questions`, {
            headers: headers,
        })
        return data
    } catch (error) {
...
export const getIndividualChatSessions = async (id, headers) => {
    try {
        const data = await axios.get(`${INDIVIDUAL_SESSION_CHAT}${id}`, {
            headers: headers,
        })
        return data
    } catch (error) {
...
export const getUsageSubscription = async (headers) => {
    try {
        const data = await axios.get(USAGE_SUBSCRIPTION, { headers: headers })
        return data
    } catch (error) {
        console.log(
            'Failed to get usage subscription details in dashboard',
            error
        )
