        ...
        organisation?.organisationStatus == 'edit' ||
            ...
            ? {
                  ...
                  address: {
                      ...
                      address1:
                          organisation?.organisationData?.address?.address1,
                      address2:
                          organisation?.organisationData?.address?.address2,
                      country:
                          organisation?.organisationData?.address?.country
                              ?.countryName,
                      state: organisation?.organisationData?.address?.state
                          ?.stateName,
                      city: organisation?.organisationData?.address?.city,
                      postCode:
                          organisation?.organisationData?.address?.postCode,
                      landmark: '',
                      countryCode:
                          organisation?.organisationData?.address?.country
                              ?.countryCode,
                      stateCode:
                          organisation?.organisationData?.address?.state
                              ?.stateCode,
                  },
                  name: organisation?.organisationData?.name,
                  contact: {
                      firstName: organisation?.organisationData?.contact
                          ?.firstName
                          ? organisation?.organisationData?.contact?.firstName
                          : '',
                      lastName: organisation?.organisationData?.contact
                          ?.lastName
    ...
    const domainNameValidation = (domainArray) => {
        if (orgData?.contact?.email.length > 0) {
            let isDomainValid = domainArray.find(
                (obj) =>
                    obj['typeDetails'] == extractDomain(orgData?.contact?.email)
            )
