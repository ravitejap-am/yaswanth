...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-policy-container">
      <div className={Styles.PrivacyPolicyHeaderStyle}>
        <p className={Styles.PrivacyPolicyContentStyle}>
          Privacy Policy for AM-Chat
        </p>
      </div>

      <div className={Styles.PrivacyPolicySecondDiv}>
        ...
        <h2 className={Styles.privacyPolicySubHeading}>
          Interpretation and Definitions
        </h2>
        <h3 className={Styles.privacyPolicySubSubHeading}>Interpretation</h3>
        <p className={Styles.PrivacyPolicyContentStyle}>
        ...
        <h3 className={Styles.privacyPolicySubSubHeading}>Definitions</h3>
        <p className={Styles.PrivacyPolicyContentStyle}>
        ...
        <ul>
          ...
          <li>
            <p className={Styles.PrivacyPolicyContentStyle}>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Areteminds.com,
              Bangalore.
            </p>
          </li>
          <li>
        ...
        <h3 className={Styles.privacyPolicySubSubHeading}>
          Types of Data Collected
        </h3>
        <h4 className={Styles.privacyPolicySubSubHeading}>Personal Data</h4>
        <p className={Styles.PrivacyPolicyContentStyle}>
        ...
        <ul>
          <li>
            <p className={Styles.PrivacyPolicyContentStyle}>Email address</p>
          </li>
          <li>
            <p className={Styles.PrivacyPolicyContentStyle}>
          ...
          <li>
            <p className={Styles.PrivacyPolicyContentStyle}>Usage Data</p>
          </li>
        </ul>
        <h4>Usage Data</h4>
        <p className={Styles.privacyPolicySubSubHeading}>
