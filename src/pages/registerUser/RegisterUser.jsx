...
const RegisterUser = () => {
    ...
    const validateDetails = () => {
        ...
        if (isValidConfirmPassword) {
            flag = true
            console.log(
                'inside invalid confirm password',
            ...
            <div className="signup-main-css">
                <Box className="text-top-signup" mb={1}>
                    ...
                    {isMobile ? (
                        ...
                        >
                            {' '}
                            Please sign up with your organisation email ID. If
                            your organisation is not registered with us, please
                            reach out to us at
                            <a
                        ...
                        >
                            ...
                            Please sign up with your organisation email ID. If
                            your <br />
                            organisation is not registered with us, please reach
                            out <br /> to us at
                            <a
                                href="mailto:sales@areteminds.com"
                                target="_blank"
