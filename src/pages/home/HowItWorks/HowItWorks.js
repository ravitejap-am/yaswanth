        ...
        },
        {
            title: (
                ...
                >
                    <Typography
                        variant="h5"
                        className="Sub_Title_of_how_it_Works"
                    >
                        Sign Up
                    </Typography>
                </Link>
        ...
        },
        {
            ...
            description: (
                <Typography
                    ...
                    className="how_to_works_span_text"
                >
                    Sign in using your organisation email and your password.{' '}
                    <br /> <br />
                </Typography>
            ),
            icon: <img src={Stepper} style={{ width: '1.5em' }} />,
        },
        {
            ...
            description: (
                ...
                >
                    ...
                    organisation and let the data talk. <br /> <br />
                </Typography>
            ),
            icon: <img src={Stepper} style={{ width: '1.5em' }} />,
        },
        ...
        <div className="How_It_Works_Main_Div">
            <div className="How_It_Works">
                ...
                <Typography
                    variant="body2"
                    mb={3}
                    className="How_it_works_Your_Org"
                >
                    Your organization likely has a vast repository of documents
                    stored in an archive. By uploading them and creating a
                    knowledge base, you can interact more effectively with your
                    documents.
                </Typography>
            </div>
