    ...
    const columns = [
        {
            ...
            title: 'Analytics',
            subTitle:
                'Find about the usage of your organisational knowledge base.',
        },
        {
            img: img3,
            title: 'Insights',
        ...
        },
        {
            ...
            subTitle:
                'Use the Gen AI based chat in your language, say goodbye to language barriers. ',
        },
        {
            img: img1,
    ...
    return (
        <div className="AI_Solution_Main_div">
            <div className="AI_Solution_title_style">
                <Typography variant="h4" sx={smallTextStyles}>
                    Explore a Gen AI Chatbot Solution for your Business
                </Typography>
            </div>
            <br />
            <div className="AI_Solution_title_style2">
                <Typography variant="body2" style={{ fontSize: '16px' }}>
                    It's completely secured, personalized and scalable.
                </Typography>
            </div>
