    ...
    <div className="TermAndCondition-container">
      ...
      <div className={Styles.TermAndConditionSecondDiv}>
        ...
        <p className={Styles.TermAndConditionContentStyle}>
          ...
          these Terms. If you disagree with any of these Terms, you may not use
          the Chatbot.
        </p>
        ...
        <h2 className={Styles.TermAndConditionSubSubHeading}>Access and Use</h2>
        <p className={Styles.TermAndConditionContentStyle}>
          You must be at least 13 years old to use the Chatbot. You are
          responsible for ensuring that all users accessing the Chatbot through
          your account are authorized to do so and comply with these Terms.
          <br />
        </p>
        <p className={Styles.TermAndConditionContentStyle}>
        ...
        <ul>
          <li>
            <p className={Styles.TermAndConditionContentStyle}>
              <strong>Violating</strong> any local, state, national, or
              international law or regulation.
            </p>
          </li>
          <li>
            <p className={Styles.TermAndConditionContentStyle}>
              <strong>Infringing</strong> on any third-party's intellectual
              property rights.
            </p>
          </li>
          <li>
          ...
          <li>
            <p className={Styles.TermAndConditionContentStyle}>
              <strong>Impersonating</strong> any person or entity, or
              misrepresenting your affiliation with any person or entity.
            </p>
          </li>
          <li>
            <p className={Styles.TermAndConditionContentStyle}>
              <strong>Interfering</strong> with or disrupting the operation of
              the Chatbot or any servers or networks connected to the Chatbot.
            </p>
          </li>
          <li>
            <p className={Styles.TermAndConditionContentStyle}>
              <strong>Attempting</strong> to gain unauthorized access to the
              Chatbot, any related systems or networks, or any part of our
              infrastructure.
            </p>
          </li>
        </ul>
        ...
        <p className={Styles.TermAndConditionContentStyle}>
          ...
          share through the Chatbot ("User Content"). You represent and warrant
          that you have all necessary rights, licenses, and consents to share
          your User Content and that your User Content does not violate any
          third-party rights.
        </p>
        <p className={Styles.TermAndConditionContentStyle}>
        ...
        <p className={Styles.TermAndConditionContentStyle}>
          The Chatbot is provided "as is" and without any warranty of any kind,
          express or implied. We disclaim all warranties, express or implied,
          including, but not limited to, warranties of merchantability, fitness
          for a particular purpose, and non-infringement.
        </p>

        <p className={Styles.TermAndConditionContentStyle}>
          We do not warrant that the Chatbot will be uninterrupted, error-free,
          secure, or reliable. We may modify or discontinue the Chatbot at any
          time without notice.
        </p>
        <h4 className={Styles.TermAndConditionSubSubHeading}>
          {" "}
        ...
        <p className={Styles.TermAndConditionContentStyle}>
          ...
          the Chatbot or your violation of these Terms.
        </p>
        ...
        <p className={Styles.TermAndConditionContentStyle}>
          ...
          laws of the State of Karnataka, without regard to its conflict of laws
          provisions. Any dispute arising out of or relating to these Terms
          shall be resolved by binding arbitration in accordance with the rules
          of the American Arbitration Association. The arbitration shall be
          conducted in the English language and shall be held in Bangalore,
          Karnataka.
        </p>
        ...
        <p className={Styles.TermAndConditionContentStyle}>
          ...
          the Chatbot. You are responsible for regularly reviewing the Terms.
          Your continued use of the Chatbot after the posting of revised Terms
